...
4. `NowEnginePanel`: expone la tarea “Now”, Focus Lock y el Parking; utiliza `src/lib/nowActions.ts` para ejecutar las funciones SQL y muestra los estados resultantes.
